 ...
 -->
	<form name="frm" method="post" action="./createForm.jsp"
		...
		<div align="center" style="height: 750px">
			<div align="center"
				style='width: 20%; border: 0px solid black; font-size: 45px'>약관동의</div>
			<br>

			<table border="0" cellspacing="0" cellpadding="2" align="center">
				<tr>
					<td align="center"><textarea cols="100" rows="20">Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
			...
			<div style="text-align: center">
				<label for="l1"><input id="l1" type="checkbox" name="agree"
					value="1"> 약관에 동의합니다</input></label> <input type="submit" value="회원가입"
					style="background-color: window; border: none; font: icon;"></input> <input
