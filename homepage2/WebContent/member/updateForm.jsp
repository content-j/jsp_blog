...
url += "?email="+email;
var wr = window.open(url,"이메일중복확인","width=500,height=500");
 ...
 onsubmit="return inputCheck(this)">
  ...
  <TABLE>
    ...
    <TR>
      ...
      size="15" value="<%=dto.getTel()%>"></TD>
      <td>변경할 전화번호를 입력하세요</td>
    </TR>
    <TR>
      <TH>*이메일</TH>
      <TD><input type="text" name="email" size="25" 
      value="<%=dto.getEmail()%>" onClick="emailCheck2(this)">
    ...
    <TR>
      ...
      size="40" id="sample6_address" 
      placeholder="주소" value="<%=dto.getAddress1()%>">
